...
public class TestEstimatedBetweennessCentralityPlain {
	...
	public static def main(args: Array[String](1)): void {
		...
		val result = BetweennessCentrality.estimate(graph, vertexList, false, iterations);
