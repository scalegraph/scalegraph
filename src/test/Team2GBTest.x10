...
public class Team2GBTest {
	...
	static def testbcast1() : void{
		...
		finish for (p in Place.places()) async at (p) {
			val role = here.id;
                        val src = (role == root) ? new Array[Long](counts * comm.size(), (i:Int)=> i as Long) : [0L];
                        val oracle = role;
	...
	static def testscatterv() : void{
		...
		finish for (p in Place.places()) async at (p) {
			val role = here.id;
                        ...
                        val src_offs = new Array[Long](comm.size(), (i:Int)=> i * counts as Long);
                        val src_counts = new Array[Long](comm.size(), (i:Int)=> counts as Long);
