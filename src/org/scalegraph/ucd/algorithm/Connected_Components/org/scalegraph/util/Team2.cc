...
x10_int org::scalegraph::util::Team2::role() {
    ...
    return (__extension__ ({
        ...
        x10::array::Array<x10_int>* this98449 = x10aux::nullCheck((*this)->
                                                                    FMGL(base))->role();
        ...
        goto __ret98451; __ret98451: {
        {
            ...
            if (x10aux::nullCheck(this98449)->FMGL(rail)) {
                ...
                ret98450 = (x10aux::nullCheck(this98449)->
                              FMGL(raw))->__apply(((x10_int) ((((x10_int)0)) - (x10aux::nullCheck(this98449)->
                                                                                  FMGL(layout_min0)))));
        ...
        }goto __ret98451_end_; __ret98451_end_: ;
        }
        ret98450;
        }))
        ;
...
void org::scalegraph::util::Team2::barrier() {
    ...
    x10aux::nullCheck((*this)->FMGL(base))->barrier((__extension__ ({
                                                        ...
                                                        org::scalegraph::util::Team2 this98452 =
                                                          (*this);
                                                        (__extension__ ({
                                                            
                                                            //#line 38 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
                                                            x10::array::Array<x10_int>* this98454 =
                                                              x10aux::nullCheck(this98452->
                                                                                  FMGL(base))->role();
                                                            ...
                                                            //#line 452 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": polyglot.ast.Labeled_c
                                                            goto __ret98456; __ret98456: {
                                                            {
                                                                
                                                                //#line 454 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10If_c
                                                                if (x10aux::nullCheck(this98454)->
                                                                      FMGL(rail))
                                                                {
                                                                    
                                                                    //#line 456 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10LocalAssign_c
                                                                    ret98455 =
                                                                      (x10aux::nullCheck(this98454)->
                                                                         FMGL(raw))->__apply(((x10_int)0));
                                                                    
                                                                    //#line 456 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": polyglot.ast.Branch_c
                                                                    goto __ret98456_end_;
                                                                }
                                                                else
                                                                {
                                                                    ...
                                                                    ret98455 =
                                                                      (x10aux::nullCheck(this98454)->
                                                                         FMGL(raw))->__apply(((x10_int) ((((x10_int)0)) - (x10aux::nullCheck(this98454)->
                                                                                                                             FMGL(layout_min0)))));
                                                            ...
                                                            }goto __ret98456_end_; __ret98456_end_: ;
                                                            }
                                                            ret98455;
                                                            }))
                                                            ;
...
x10_boolean org::scalegraph::util::Team2::equals(x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 this101347 = (*this);
        
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 other101346 = x10aux::class_cast<org::scalegraph::util::Team2>(other);
        (x10aux::struct_equals(this101347->FMGL(base), other101346->
                                                         FMGL(base)));
    }))
    ;
...
x10_boolean org::scalegraph::util::Team2::_struct_equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 this101349 = (*this);
        
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 other101348 = x10aux::class_cast<org::scalegraph::util::Team2>(other);
        (x10aux::struct_equals(this101349->FMGL(base), other101348->
                                                         FMGL(base)));
    }))
    ;
