    ...
    void __apply(org::scalegraph::util::SStringBuilder sb, x10_long idx) {
        ...
        org::scalegraph::util::StringBuilderAdd_(sb,(__extension__ ({
            ...
            TPMGL(T) ret131917;
            {
                ...
                if (((index131916) < (((x10_long) (((x10_int)0))))) || ((index131916) >= (mc->
                                                                                            FMGL(data)->
                                                                                            FMGL(size))))
                {
                    ...
                    if (true) {
                        ...
                        x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index131916), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                    }
            ...
            ret131917 = (mc->FMGL(data))[index131916];
            ret131917;
        }))
        );
    }
...
template<class TPMGL(T)> class org_scalegraph_io_impl_CSVAttributeHandler__BaseHandler__closure__3 : public x10::lang::Closure {
    ...
    void __apply() {
        ...
        try {
            ...
            if (true) {
                x10::lang::CheckedThrowable* __lowerer__var__0__ = static_cast<x10::lang::CheckedThrowable*>(__exc1597);
                {
...
template<class TPMGL(T)> void org::scalegraph::io::impl::CSVAttributeHandler__BaseHandler<TPMGL(T)>::_constructor(
    ...
    org::scalegraph::io::impl::CSVAttributeHandler* this132096 = this;
    ...
    x10_int typeId132097 = typeId;
    
    //#line 44 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/impl/CSVAttributeHandler.x10": x10.ast.X10LocalDecl_c
    x10_boolean doubleQuoated132098 = doubleQuoated;
    ...
    x10aux::nullCheck(this132096)->FMGL(typeId) = typeId132097;
    ...
    x10aux::nullCheck(this132096)->FMGL(doubleQuoated) = doubleQuoated132098;
...
template<class TPMGL(T)> x10_long org::scalegraph::io::impl::CSVAttributeHandler__BaseHandler<TPMGL(T)>::localSizeOf(
  x10::lang::Any* any) {
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this131915 =
          dmc->org::scalegraph::util::DistMemoryChunk<TPMGL(T)>::__apply();
        this131915->FMGL(data)->FMGL(size);
    }))
    ;
...
template<class TPMGL(T)> x10::lang::Any* org::scalegraph::io::impl::CSVAttributeHandler__BaseHandler<TPMGL(T)>::createBlockGrowableMemory(
    ...
    return reinterpret_cast<x10::lang::Any*>((__extension__ ({
        ...
        org::scalegraph::util::GrowableMemory<TPMGL(T)>* alloc130601 =
        ...
        (alloc130601)->::org::scalegraph::util::GrowableMemory<TPMGL(T)>::_constructor(
          ((x10_long)0ll));
        alloc130601;
    }))
    );
        ...
        for (
             ...
             i = ((x10_int) ((i) + (((x10_int)1))))) {
            {
                ...
                x10::lang::Runtime::runAt((__extension__ ({
                                              ...
                                              //#line 146 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/impl/CSVAttributeHandler.x10": x10.ast.X10LocalDecl_c
                                              x10::array::Array<x10::lang::Place>* this131921 =
                                              ...
                                              goto __ret131923; __ret131923: {
                                              {
                                                        ...
                                                        FMGL(rail))
                                                  {
                                                      ...
                                                      ret131922 =
                                                        (x10aux::nullCheck(this131921)->
                                                           FMGL(raw))->__apply(((x10_int) ((i131920) - (x10aux::nullCheck(this131921)->
                                                                                                          FMGL(layout_min0)))));
                                              ...
                                              }goto __ret131923_end_; __ret131923_end_: ;
                                              }
                                              ret131922;
                                              }))
