...
class IdStruct   {
    ...
    x10_long localIDMask() {
        ...
        return ((x10_long) (((__extension__ ({
            ...
            org::scalegraph::graph::id::IdStruct this107104 =
              (*this);
            ((x10_long) ((((x10_long)1ll)) << (0x3f & (this107104->
                                                         FMGL(lgl)))));
        }))
        ) - (((x10_long) (((x10_int)1))))));
    ...
    x10_long localRIDMask() {
        ...
        return ((x10_long) (((__extension__ ({
            ...
            org::scalegraph::graph::id::IdStruct this107105 =
              (*this);
            ((x10_long) ((((x10_long)1ll)) << (0x3f & (((x10_int) ((this107105->
                                                                      FMGL(lgr)) + (this107105->
                                                                                      FMGL(lgl))))))));
        }))
        ) - (((x10_long) (((x10_int)1))))));
    ...
    x10_long localCIDMask() {
        ...
        return ((x10_long) (((__extension__ ({
            ...
            org::scalegraph::graph::id::IdStruct this107106 =
              (*this);
            ((x10_long) ((((x10_long)1ll)) << (0x3f & (((x10_int) ((this107106->
                                                                      FMGL(lgc)) + (this107106->
                                                                                      FMGL(lgl))))))));
        }))
        ) - (((x10_long) (((x10_int)1))))));
