...
template<class TPMGL(T)> class org_scalegraph_util_DistGrowableMemory__closure__1 : public x10::lang::Closure {
    ...
    org::scalegraph::util::GrowableMemory<TPMGL(T)>* __apply() {
        ...
        return (__extension__ ({
            ...
            org::scalegraph::util::GrowableMemory<TPMGL(T)>* alloc123904 =
            ...
            (alloc123904)->::org::scalegraph::util::GrowableMemory<TPMGL(T)>::_constructor(
              ((x10_long)0ll));
            alloc123904;
        }))
        ;
...
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
  ...
  x10::array::PlaceGroup* placeGroup) {
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::DistMemoryChunk<TPMGL(T)> alloc123905 =
        ...
        (alloc123905)->::org::scalegraph::util::DistMemoryChunk<TPMGL(T)>::_constructor(
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::DistGrowableMemory<TPMGL(T)>::equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> this123908 =
          (*this);
        
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> other123907 =
          x10aux::class_cast<org::scalegraph::util::DistGrowableMemory<TPMGL(T)> >(other);
        (x10aux::struct_equals(this123908->FMGL(plh), other123907->
                                                        FMGL(plh)));
    }))
    ;
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::DistGrowableMemory<TPMGL(T)>::_struct_equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> this123910 =
          (*this);
        
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> other123909 =
          x10aux::class_cast<org::scalegraph::util::DistGrowableMemory<TPMGL(T)> >(other);
        (x10aux::struct_equals(this123910->FMGL(plh), other123909->
                                                        FMGL(plh)));
    }))
    ;
