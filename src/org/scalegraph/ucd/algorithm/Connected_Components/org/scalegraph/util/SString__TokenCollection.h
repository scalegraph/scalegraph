...
template<class TPMGL(T)> x10_int org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::size(
    ...
    {
        org::scalegraph::util::SString__TokenIterator<TPMGL(T)> t83499;
        for (
             ...
             t83499 = x10aux::class_cast_unchecked<org::scalegraph::util::SString__TokenIterator<TPMGL(T)> >((*this)->org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::iterator());
             t83499->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::hasNext();
             ) {
            
            //#line 192 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/SString.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString t = t83499->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::next();
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<org::scalegraph::util::SString>
  org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::result(
    ...
    {
        org::scalegraph::util::SString__TokenIterator<TPMGL(T)> t83501;
        for (
             ...
             t83501 = x10aux::class_cast_unchecked<org::scalegraph::util::SString__TokenIterator<TPMGL(T)> >((*this)->org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::iterator());
             t83501->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::hasNext();
             ) {
            
            //#line 198 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/SString.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString t = t83501->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::next();
            ...
            x10_int index120162 = ((x10_int) ((tokenCount =
              ((x10_int) ((tokenCount) + (((x10_int)1))))) - (((x10_int)1))));
            
            //#line 283 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString value120163 = t;
            
            //#line 283 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString ret120164;
            {
                ...
                if (((index120162) < (((x10_int)0))) || ((((x10_long) (index120162))) >= (array->
                                                                                            FMGL(data)->
                                                                                            FMGL(size))))
                {
                    ...
                    if (true) {
                        ...
                        x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index120162), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                    }
            ...
            (array->FMGL(data)).set(index120162, value120163);
