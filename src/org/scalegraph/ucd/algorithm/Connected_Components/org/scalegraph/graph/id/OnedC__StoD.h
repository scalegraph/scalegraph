...
class OnedC__StoD   {
    ...
    x10_long __apply(x10_long id) {
        ...
        //#line 107 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/id/OnedC.x10": x10.ast.X10Return_c
        return ((x10_long) ((id) & ((*this)->FMGL(lmask))));
        
    }
    x10_int c(x10_long id) {
        
        //#line 108 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/id/OnedC.x10": x10.ast.X10Return_c
