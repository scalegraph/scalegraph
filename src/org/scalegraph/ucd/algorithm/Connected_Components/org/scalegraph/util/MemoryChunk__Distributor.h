...
template<class TPMGL(T)> class MemoryChunk__Distributor : public x10::lang::X10Class
  {
    ...
    virtual void __fieldInitializers51500();
...
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::_constructor(
    ...
    org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* this81503 =
      this;
    ...
    x10aux::nullCheck(this81503)->FMGL(offset) = ((x10_long) (((x10_int)0)));
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  ...
  x10_long size) {
    ...
    org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* x81504 =
      this;
    
    //#line 56 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
    x10_long y81505 = size;
    ...
    x10aux::nullCheck(x81504)->FMGL(offset) = ((x10_long) ((x10aux::nullCheck(x81504)->
                                                              FMGL(offset)) + (y81505)));
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  ...
  x10_int size) {
    ...
    org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* x81506 =
      this;
    ...
    x10aux::nullCheck(x81506)->FMGL(offset) = ((x10_long) ((x10aux::nullCheck(x81506)->
                                                              FMGL(offset)) + (((x10_long) (y81507)))));
...
template<class TPMGL(T)> x10_long org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::remain(
    ...
    return ((x10_long) (((__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this79384 =
          this->FMGL(outer);
        this79384->FMGL(data)->FMGL(size);
    }))
    ) - (this->FMGL(offset))));
...
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::checkFinish(
    ...
    if ((!x10aux::struct_equals(this->FMGL(offset), (__extension__ ({
                                    ...
                                    org::scalegraph::util::MemoryChunk<TPMGL(T)> this79385 =
                                      this->FMGL(outer);
                                    this79385->FMGL(data)->
                                      FMGL(size);
                                }))
...
//#line 41 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::__fieldInitializers51500(
  ) {
