...
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
    ...
    x10_long i52332max81508 = ((x10_long) ((size) - (((x10_long)1ll))));
    ...
    //#line 87 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": polyglot.ast.For_c
    {
        ...
        for (
             //#line 87 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
             i81509 = ((x10_long)0ll); ((i81509) <= (i52332max81508));
             ...
             i81509 = ((x10_long) ((i81509) + (((x10_long)1ll)))))
        {
            
            //#line 87 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            x10_long i81510 = i81509;
            ...
            ((*this)->FMGL(data)).set(i81510, x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(x10aux::nullCheck(init), 
              i81510));
        }
    }
...
template<class TPMGL(T)> x10::lang::String* org::scalegraph::util::MemoryChunk<TPMGL(T)>::toString(
    ...
    sb->FMGL(buf) = (__extension__ ({
        ...
        x10::util::ArrayList<x10_char>* alloc81511 =  ((new (memset(x10aux::alloc<x10::util::ArrayList<x10_char> >(), 0, sizeof(x10::util::ArrayList<x10_char>))) x10::util::ArrayList<x10_char>()))
        ;
        
        //#line 22 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/util/StringBuilder.x10": x10.ast.X10ConstructorCall_c
        (alloc81511)->::x10::util::ArrayList<x10_char>::_constructor();
        alloc81511;
    }))
    ;
    ...
    x10_long sz = (__extension__ ({
        ...
        x10_long a80592 = (__extension__ ({
            
            //#line 176 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::MemoryChunk<TPMGL(T)> this80591 =
              (*this);
            this80591->FMGL(data)->FMGL(size);
        }))
        ;
        
        //#line 352 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": polyglot.ast.Empty_c
        ;
        ((a80592) < (((x10_long)10ll))) ? (a80592) : (((x10_long)10ll));
    }))
    ;
    ...
    if (((sz) < ((__extension__ ({
            ...
            org::scalegraph::util::MemoryChunk<TPMGL(T)> this80594 =
              (*this);
            this80594->FMGL(data)->FMGL(size);
        }))
        ))) {
        ...
        sb->add(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("...(omitted "), ((x10_long) (((__extension__ ({
                    ...
                    //#line 181 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                    org::scalegraph::util::MemoryChunk<TPMGL(T)> this80595 =
                      (*this);
                    this80595->FMGL(data)->FMGL(size);
                }))
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>*
  org::scalegraph::util::MemoryChunk<TPMGL(T)>::distributor(
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* alloc52327 =
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> outer81512 =
          (*this);
        ...
        alloc52327->FMGL(offset) = ((x10_long) (((x10_int)0)));
        ...
        alloc52327->FMGL(outer) = outer81512;
        alloc52327;
    }))
    ;
...
template<class TPMGL(T)> x10::lang::Iterator<TPMGL(T)>* org::scalegraph::util::MemoryChunk<TPMGL(T)>::iterator(
    ...
    return reinterpret_cast<x10::lang::Iterator<TPMGL(T)>*>((__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>* alloc52328 =
        ...
        org::scalegraph::util::MCData_Impl<TPMGL(T) > data81514 =
          (*this)->FMGL(data);
        ...
        alloc52328->FMGL(cur) = ((x10_long)0ll);
        ...
        alloc52328->FMGL(data) = data81514;
        alloc52328;
    }))
    );
...
template<class TPMGL(T)> x10::array::Array<TPMGL(T)>* org::scalegraph::util::MemoryChunk<TPMGL(T)>::toArray(
    ...
    return (__extension__ ({
        ...
        x10::array::Array<TPMGL(T)>* alloc52329 =  ((new (memset(x10aux::alloc<x10::array::Array<TPMGL(T)> >(), 0, sizeof(x10::array::Array<TPMGL(T)>))) x10::array::Array<TPMGL(T)>()))
        ;
        
        //#line 313 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10LocalDecl_c
        x10_int size81521 = ((x10_int) ((*this)->FMGL(data)->
                                          FMGL(size)));
        ...
        x10::array::RectRegion1D* myReg81519 =  ((new (memset(x10aux::alloc<x10::array::RectRegion1D>(), 0, sizeof(x10::array::RectRegion1D))) x10::array::RectRegion1D()))
        ;
        
        //#line 315 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10ConstructorCall_c
        (myReg81519)->::x10::array::RectRegion1D::_constructor(
          ((x10_int) ((size81521) - (((x10_int)1)))));
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(region) = reinterpret_cast<x10::array::Region*>(myReg81519);
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(rank) = ((x10_int)1);
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(rect) = true;
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(zeroBased) = true;
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(rail) = true;
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(size) = size81521;
        
        //#line 318 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(layout_min0) = alloc52329->FMGL(layout_stride1) =
          alloc52329->FMGL(layout_min1) = ((x10_int)0);
        
        //#line 319 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52329->FMGL(layout) = (x10aux::class_cast_unchecked<x10::array::Array<x10_int>*>(X10_NULL));
        
        //#line 320 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10LocalDecl_c
        x10::util::IndexedMemoryChunk<TPMGL(T) > r81520 =
          x10::util::IndexedMemoryChunk<void>::allocate<TPMGL(T) >(size81521, 8, false, false);
        
        //#line 321 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10LocalDecl_c
        x10_int i67566max81516 = ((x10_int) ((size81521) - (((x10_int)1))));
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  org::scalegraph::util::MemoryChunk<TPMGL(T)>::clone() {
    ...
    org::scalegraph::util::MemoryChunk<TPMGL(T)> ret = org::scalegraph::util::MemoryChunk<TPMGL(T) >::_make((__extension__ ({
        ...
        //#line 235 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this81495 =
          (*this);
        this81495->FMGL(data)->FMGL(size);
    }))
    ...
    org::scalegraph::util::MemoryChunk<void>::template copy<TPMGL(T) >(
      (*this), ((x10_long)0ll), ret, ((x10_long)0ll), (__extension__ ({
          ...
          org::scalegraph::util::MemoryChunk<TPMGL(T)> this81496 =
            (*this);
          this81496->FMGL(data)->FMGL(size);
      }))
      );
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  org::scalegraph::util::MemoryChunk<TPMGL(T)>::subpart(x10_long offset,
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52330 =
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::MemoryChunk<TPMGL(T)>::equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this81500 =
          (*this);
        
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> other81499 =
          x10aux::class_cast<org::scalegraph::util::MemoryChunk<TPMGL(T)> >(other);
        (x10aux::struct_equals(this81500->FMGL(data), other81499->
                                                        FMGL(data)));
    }))
    ;
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::MemoryChunk<TPMGL(T)>::_struct_equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this81502 =
          (*this);
        
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> other81501 =
          x10aux::class_cast<org::scalegraph::util::MemoryChunk<TPMGL(T)> >(other);
        (x10aux::struct_equals(this81502->FMGL(data), other81501->
                                                        FMGL(data)));
    }))
    ;
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  org::scalegraph::util::MemoryChunk<void>::make() {
                                                       ...
                                                       return (__extension__ ({
                                                           ...
                                                           org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52321 =
                                                 ...
                                                 x10_long size)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52322 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52322)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
          imc, offset, size);
        alloc52322;
    }))
    ;
                                                 ...
                                                 x10_int size)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52323 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52323)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
                                                 ...
                                                 x10_long offset)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52324 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52324)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
                                                 ...
                                                 x10_int offset)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52325 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52325)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
  ...
  org::scalegraph::util::MemoryChunk<void>::make(x10::util::IndexedMemoryChunk<TPMGL(T) > imc)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52326 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52326)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
