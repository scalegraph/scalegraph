...
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
    ...
    x10_long i52566max82395 = ((x10_long) ((size) - (((x10_long)1ll))));
    ...
    //#line 87 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": polyglot.ast.For_c
    {
        ...
        for (
             //#line 87 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
             i82396 = ((x10_long)0ll); ((i82396) <= (i52566max82395));
             ...
             i82396 = ((x10_long) ((i82396) + (((x10_long)1ll)))))
        {
            
            //#line 87 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            x10_long i82397 = i82396;
            ...
            ((*this)->FMGL(data)).set(i82397, x10::lang::Fun_0_1<x10_long, TPMGL(T)>::__apply(x10aux::nullCheck(init), 
              i82397));
        }
    }
...
template<class TPMGL(T)> x10::lang::String* org::scalegraph::util::MemoryChunk<TPMGL(T)>::toString(
    ...
    sb->FMGL(buf) = (__extension__ ({
        ...
        x10::util::ArrayList<x10_char>* alloc82398 =  ((new (memset(x10aux::alloc<x10::util::ArrayList<x10_char> >(), 0, sizeof(x10::util::ArrayList<x10_char>))) x10::util::ArrayList<x10_char>()))
        ;
        
        //#line 22 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/util/StringBuilder.x10": x10.ast.X10ConstructorCall_c
        (alloc82398)->::x10::util::ArrayList<x10_char>::_constructor();
        alloc82398;
    }))
    ;
    ...
    x10_long sz = (__extension__ ({
        ...
        x10_long a81479 = (__extension__ ({
            
            //#line 176 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::MemoryChunk<TPMGL(T)> this81478 =
              (*this);
            this81478->FMGL(data)->FMGL(size);
        }))
        ;
        
        //#line 352 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": polyglot.ast.Empty_c
        ;
        ((a81479) < (((x10_long)10ll))) ? (a81479) : (((x10_long)10ll));
    }))
    ;
    ...
    if (((sz) < ((__extension__ ({
            ...
            org::scalegraph::util::MemoryChunk<TPMGL(T)> this81481 =
              (*this);
            this81481->FMGL(data)->FMGL(size);
        }))
        ))) {
        ...
        sb->add(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("...(omitted "), ((x10_long) (((__extension__ ({
                    ...
                    //#line 181 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                    org::scalegraph::util::MemoryChunk<TPMGL(T)> this81482 =
                      (*this);
                    this81482->FMGL(data)->FMGL(size);
                }))
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>*
  org::scalegraph::util::MemoryChunk<TPMGL(T)>::distributor(
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* alloc52561 =
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> outer82399 =
          (*this);
        ...
        alloc52561->FMGL(offset) = ((x10_long) (((x10_int)0)));
        ...
        alloc52561->FMGL(outer) = outer82399;
        alloc52561;
    }))
    ;
...
template<class TPMGL(T)> x10::lang::Iterator<TPMGL(T)>* org::scalegraph::util::MemoryChunk<TPMGL(T)>::iterator(
    ...
    return reinterpret_cast<x10::lang::Iterator<TPMGL(T)>*>((__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>* alloc52562 =
        ...
        org::scalegraph::util::MCData_Impl<TPMGL(T) > data82401 =
          (*this)->FMGL(data);
        ...
        alloc52562->FMGL(cur) = ((x10_long)0ll);
        ...
        alloc52562->FMGL(data) = data82401;
        alloc52562;
    }))
    );
...
template<class TPMGL(T)> x10::array::Array<TPMGL(T)>* org::scalegraph::util::MemoryChunk<TPMGL(T)>::toArray(
    ...
    return (__extension__ ({
        ...
        x10::array::Array<TPMGL(T)>* alloc52563 =  ((new (memset(x10aux::alloc<x10::array::Array<TPMGL(T)> >(), 0, sizeof(x10::array::Array<TPMGL(T)>))) x10::array::Array<TPMGL(T)>()))
        ;
        
        //#line 313 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10LocalDecl_c
        x10_int size82408 = ((x10_int) ((*this)->FMGL(data)->
                                          FMGL(size)));
        ...
        x10::array::RectRegion1D* myReg82406 =  ((new (memset(x10aux::alloc<x10::array::RectRegion1D>(), 0, sizeof(x10::array::RectRegion1D))) x10::array::RectRegion1D()))
        ;
        
        //#line 315 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10ConstructorCall_c
        (myReg82406)->::x10::array::RectRegion1D::_constructor(
          ((x10_int) ((size82408) - (((x10_int)1)))));
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(region) = reinterpret_cast<x10::array::Region*>(myReg82406);
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(rank) = ((x10_int)1);
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(rect) = true;
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(zeroBased) = true;
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(rail) = true;
        
        //#line 316 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(size) = size82408;
        
        //#line 318 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(layout_min0) = alloc52563->FMGL(layout_stride1) =
          alloc52563->FMGL(layout_min1) = ((x10_int)0);
        
        //#line 319 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10FieldAssign_c
        alloc52563->FMGL(layout) = (x10aux::class_cast_unchecked<x10::array::Array<x10_int>*>(X10_NULL));
        
        //#line 320 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10LocalDecl_c
        x10::util::IndexedMemoryChunk<TPMGL(T) > r82407 =
          x10::util::IndexedMemoryChunk<void>::allocate<TPMGL(T) >(size82408, 8, false, false);
        
        //#line 321 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10LocalDecl_c
        x10_int i69157max82403 = ((x10_int) ((size82408) - (((x10_int)1))));
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  org::scalegraph::util::MemoryChunk<TPMGL(T)>::clone() {
    ...
    org::scalegraph::util::MemoryChunk<TPMGL(T)> ret = org::scalegraph::util::MemoryChunk<TPMGL(T) >::_make((__extension__ ({
        ...
        //#line 235 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this82382 =
          (*this);
        this82382->FMGL(data)->FMGL(size);
    }))
    ...
    org::scalegraph::util::MemoryChunk<void>::template copy<TPMGL(T) >(
      (*this), ((x10_long)0ll), ret, ((x10_long)0ll), (__extension__ ({
          ...
          org::scalegraph::util::MemoryChunk<TPMGL(T)> this82383 =
            (*this);
          this82383->FMGL(data)->FMGL(size);
      }))
      );
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  org::scalegraph::util::MemoryChunk<TPMGL(T)>::subpart(x10_long offset,
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52564 =
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::MemoryChunk<TPMGL(T)>::equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this82387 =
          (*this);
        
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> other82386 =
          x10aux::class_cast<org::scalegraph::util::MemoryChunk<TPMGL(T)> >(other);
        (x10aux::struct_equals(this82387->FMGL(data), other82386->
                                                        FMGL(data)));
    }))
    ;
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::MemoryChunk<TPMGL(T)>::_struct_equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this82389 =
          (*this);
        
        //#line 36 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk<TPMGL(T)> other82388 =
          x10aux::class_cast<org::scalegraph::util::MemoryChunk<TPMGL(T)> >(other);
        (x10aux::struct_equals(this82389->FMGL(data), other82388->
                                                        FMGL(data)));
    }))
    ;
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  org::scalegraph::util::MemoryChunk<void>::make() {
                                                       ...
                                                       return (__extension__ ({
                                                           ...
                                                           org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52555 =
                                                 ...
                                                 x10_long size)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52556 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52556)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
          imc, offset, size);
        alloc52556;
    }))
    ;
                                                 ...
                                                 x10_int size)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52557 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52557)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
                                                 ...
                                                 x10_long offset)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52558 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52558)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
                                                 ...
                                                 x10_int offset)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52559 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52559)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
  ...
  org::scalegraph::util::MemoryChunk<void>::make(x10::util::IndexedMemoryChunk<TPMGL(T) > imc)
{
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> alloc52560 =
           org::scalegraph::util::MemoryChunk<TPMGL(T)>::_alloc();
        ...
        (alloc52560)->::org::scalegraph::util::MemoryChunk<TPMGL(T)>::_constructor(
