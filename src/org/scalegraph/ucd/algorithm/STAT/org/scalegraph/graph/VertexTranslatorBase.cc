...
void org::scalegraph::graph::VertexTranslatorBase::_constructor(x10::util::Team* team__) {
    ...
    org::scalegraph::graph::VertexTranslatorBase* this122778 = this;
    ...
    x10aux::nullCheck(this122778)->FMGL(maxVertexID) = ((x10_long) (((x10_int)0)));
    ...
    this->FMGL(teamRank) = (__extension__ ({
        ...
        x10::array::Array<x10_int>* this122775 = x10aux::nullCheck(this->
                                                                     FMGL(team))->role();
        ...
        goto __ret122777; __ret122777: {
        {
            ...
            if (x10aux::nullCheck(this122775)->FMGL(rail)) {
                ...
                ret122776 = (x10aux::nullCheck(this122775)->FMGL(raw))->__apply(((x10_int) ((((x10_int)0)) - (x10aux::nullCheck(this122775)->
                                                                                                                FMGL(layout_min0)))));
        ...
        }goto __ret122777_end_; __ret122777_end_: ;
        }
        ret122776;
        }))
        ;
...
//#line 15 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslatorBase.x10": x10.ast.X10MethodDecl_c
void org::scalegraph::graph::VertexTranslatorBase::__fieldInitializers93473(
  ) {
