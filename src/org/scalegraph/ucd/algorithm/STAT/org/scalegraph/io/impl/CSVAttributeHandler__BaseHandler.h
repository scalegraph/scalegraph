    ...
    void __apply(org::scalegraph::util::SStringBuilder sb, x10_long idx) {
        ...
        org::scalegraph::util::StringBuilderAdd_(sb,(__extension__ ({
            ...
            TPMGL(T) ret128372;
            {
                ...
                if (((index128371) < (((x10_long) (((x10_int)0))))) || ((index128371) >= (mc->
                                                                                            FMGL(data)->
                                                                                            FMGL(size))))
                {
                    ...
                    if (true) {
                        ...
                        x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index128371), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                    }
            ...
            ret128372 = (mc->FMGL(data))[index128371];
            ret128372;
        }))
        );
    }
...
template<class TPMGL(T)> class org_scalegraph_io_impl_CSVAttributeHandler__BaseHandler__closure__3 : public x10::lang::Closure {
    ...
    void __apply() {
        ...
        try {
            ...
            if (true) {
                x10::lang::CheckedThrowable* __lowerer__var__0__ = static_cast<x10::lang::CheckedThrowable*>(__exc1478);
                {
...
template<class TPMGL(T)> void org::scalegraph::io::impl::CSVAttributeHandler__BaseHandler<TPMGL(T)>::_constructor(
    ...
    org::scalegraph::io::impl::CSVAttributeHandler* this128551 = this;
    ...
    x10_int typeId128552 = typeId;
    
    //#line 44 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/impl/CSVAttributeHandler.x10": x10.ast.X10LocalDecl_c
    x10_boolean doubleQuoated128553 = doubleQuoated;
    ...
    x10aux::nullCheck(this128551)->FMGL(typeId) = typeId128552;
    ...
    x10aux::nullCheck(this128551)->FMGL(doubleQuoated) = doubleQuoated128553;
...
template<class TPMGL(T)> x10_long org::scalegraph::io::impl::CSVAttributeHandler__BaseHandler<TPMGL(T)>::localSizeOf(
  x10::lang::Any* any) {
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this128370 =
          dmc->org::scalegraph::util::DistMemoryChunk<TPMGL(T)>::__apply();
        this128370->FMGL(data)->FMGL(size);
    }))
    ;
...
template<class TPMGL(T)> x10::lang::Any* org::scalegraph::io::impl::CSVAttributeHandler__BaseHandler<TPMGL(T)>::createBlockGrowableMemory(
    ...
    return reinterpret_cast<x10::lang::Any*>((__extension__ ({
        ...
        org::scalegraph::util::GrowableMemory<TPMGL(T)>* alloc126389 =
        ...
        (alloc126389)->::org::scalegraph::util::GrowableMemory<TPMGL(T)>::_constructor(
          ((x10_long)0ll));
        alloc126389;
    }))
    );
        ...
        for (
             ...
             i = ((x10_int) ((i) + (((x10_int)1))))) {
            {
                ...
                x10::lang::Runtime::runAt((__extension__ ({
                                              ...
                                              //#line 146 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/impl/CSVAttributeHandler.x10": x10.ast.X10LocalDecl_c
                                              x10::array::Array<x10::lang::Place>* this128376 =
                                              ...
                                              goto __ret128378; __ret128378: {
                                              {
                                                        ...
                                                        FMGL(rail))
                                                  {
                                                      ...
                                                      ret128377 =
                                                        (x10aux::nullCheck(this128376)->
                                                           FMGL(raw))->__apply(((x10_int) ((i128375) - (x10aux::nullCheck(this128376)->
                                                                                                          FMGL(layout_min0)))));
                                              ...
                                              }goto __ret128378_end_; __ret128378_end_: ;
                                              }
                                              ret128377;
                                              }))
