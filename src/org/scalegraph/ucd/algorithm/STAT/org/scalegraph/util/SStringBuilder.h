...
class SStringBuilder   {
    ...
    void __fieldInitializers106027();
...
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1167
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1167
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1167
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1168
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1168
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1168
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1169
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1169
template<class TPMGL(T1), class TPMGL(T2)> org::scalegraph::util::SStringBuilder
  org::scalegraph::util::SStringBuilder::add(org::scalegraph::util::SString fmt,
                                             TPMGL(T1) o1,
                                             TPMGL(T2) o2){
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1169
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1170
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1170
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3)>
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1170
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1171
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1171
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1171
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1172
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1172
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4), class TPMGL(T5)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1172
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1173
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1173
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4), class TPMGL(T5), class TPMGL(T6)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1173
