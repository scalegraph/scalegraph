...
template<class TPMGL(T)> x10_int org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::size(
    ...
    {
        org::scalegraph::util::SString__TokenIterator<TPMGL(T)> t84738;
        for (
             ...
             t84738 = x10aux::class_cast_unchecked<org::scalegraph::util::SString__TokenIterator<TPMGL(T)> >((*this)->org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::iterator());
             t84738->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::hasNext();
             ) {
            
            //#line 192 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/SString.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString t = t84738->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::next();
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<org::scalegraph::util::SString>
  org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::result(
    ...
    {
        org::scalegraph::util::SString__TokenIterator<TPMGL(T)> t84740;
        for (
             ...
             t84740 = x10aux::class_cast_unchecked<org::scalegraph::util::SString__TokenIterator<TPMGL(T)> >((*this)->org::scalegraph::util::SString__TokenCollection<TPMGL(T)>::iterator());
             t84740->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::hasNext();
             ) {
            
            //#line 198 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/SString.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString t = t84740->org::scalegraph::util::SString__TokenIterator<TPMGL(T)>::next();
            ...
            x10_int index121446 = ((x10_int) ((tokenCount =
              ((x10_int) ((tokenCount) + (((x10_int)1))))) - (((x10_int)1))));
            
            //#line 283 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString value121447 = t;
            
            //#line 283 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
            org::scalegraph::util::SString ret121448;
            {
                ...
                if (((index121446) < (((x10_int)0))) || ((((x10_long) (index121446))) >= (array->
                                                                                            FMGL(data)->
                                                                                            FMGL(size))))
                {
                    ...
                    if (true) {
                        ...
                        x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index121446), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                    }
            ...
            (array->FMGL(data)).set(index121446, value121447);
