...
x10_int org::scalegraph::util::Team2::role() {
    ...
    return (__extension__ ({
        ...
        x10::array::Array<x10_int>* this99733 = x10aux::nullCheck((*this)->
                                                                    FMGL(base))->role();
        ...
        goto __ret99735; __ret99735: {
        {
            ...
            if (x10aux::nullCheck(this99733)->FMGL(rail)) {
                ...
                ret99734 = (x10aux::nullCheck(this99733)->
                              FMGL(raw))->__apply(((x10_int) ((((x10_int)0)) - (x10aux::nullCheck(this99733)->
                                                                                  FMGL(layout_min0)))));
        ...
        }goto __ret99735_end_; __ret99735_end_: ;
        }
        ret99734;
        }))
        ;
...
void org::scalegraph::util::Team2::barrier() {
    ...
    x10aux::nullCheck((*this)->FMGL(base))->barrier((__extension__ ({
                                                        ...
                                                        org::scalegraph::util::Team2 this99736 =
                                                          (*this);
                                                        (__extension__ ({
                                                            
                                                            //#line 38 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
                                                            x10::array::Array<x10_int>* this99738 =
                                                              x10aux::nullCheck(this99736->
                                                                                  FMGL(base))->role();
                                                            ...
                                                            //#line 452 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": polyglot.ast.Labeled_c
                                                            goto __ret99740; __ret99740: {
                                                            {
                                                                
                                                                //#line 454 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": x10.ast.X10If_c
                                                                if (x10aux::nullCheck(this99738)->
                                                                      FMGL(rail))
                                                                {
                                                                    
                                                                    //#line 456 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": Eval of x10.ast.X10LocalAssign_c
                                                                    ret99739 =
                                                                      (x10aux::nullCheck(this99738)->
                                                                         FMGL(raw))->__apply(((x10_int)0));
                                                                    
                                                                    //#line 456 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/array/Array.x10": polyglot.ast.Branch_c
                                                                    goto __ret99740_end_;
                                                                }
                                                                else
                                                                {
                                                                    ...
                                                                    ret99739 =
                                                                      (x10aux::nullCheck(this99738)->
                                                                         FMGL(raw))->__apply(((x10_int) ((((x10_int)0)) - (x10aux::nullCheck(this99738)->
                                                                                                                             FMGL(layout_min0)))));
                                                            ...
                                                            }goto __ret99740_end_; __ret99740_end_: ;
                                                            }
                                                            ret99739;
                                                            }))
                                                            ;
...
x10_boolean org::scalegraph::util::Team2::equals(x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 this102631 = (*this);
        
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 other102630 = x10aux::class_cast<org::scalegraph::util::Team2>(other);
        (x10aux::struct_equals(this102631->FMGL(base), other102630->
                                                         FMGL(base)));
    }))
    ;
...
x10_boolean org::scalegraph::util::Team2::_struct_equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 this102633 = (*this);
        
        //#line 30 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Team2.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::Team2 other102632 = x10aux::class_cast<org::scalegraph::util::Team2>(other);
        (x10aux::struct_equals(this102633->FMGL(base), other102632->
                                                         FMGL(base)));
    }))
    ;
