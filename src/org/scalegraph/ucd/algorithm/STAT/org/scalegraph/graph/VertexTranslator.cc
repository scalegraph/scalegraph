...
void org::scalegraph::graph::VertexTranslator<void>::FMGL(debug__do_init)() {
    ...
    x10_boolean __var1698__ = x10aux::class_cast_unchecked<x10_boolean>(true);
    FMGL(debug) = __var1698__;
...
class org_scalegraph_graph_VertexTranslator__NoTraslator__closure__10 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long tid, x10::lang::LongRange r) {
        ...
        x10::lang::LongRange i93441domain133682 = r;
        
        //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i93441min133683 = i93441domain133682->FMGL(min);
        
        //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i93441max133684 = i93441domain133682->FMGL(max);
        ...
        //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": polyglot.ast.For_c
        {
            ...
            for (
                 //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                 i133685 = i93441min133683; ((i133685) <= (i93441max133684));
                 ...
                 i133685 = ((x10_long) ((i133685) + (((x10_long)1ll))))) {
                
                //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                x10_long i133686 = i133685;
                ...
                x10_long v133679 = (__extension__ ({
                    
                    //#line 270 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                    x10_long index133680 = i133686;
                    ...
                    x10_long ret133681;
                    {
                        ...
                        if (((index133680) < (((x10_long) (((x10_int)0))))) ||
                            ((index133680) >= (vertexes->FMGL(data)->FMGL(size))))
                        {
                            ...
                            if (true) {
                                ...
                                x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index133680), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                            }
                    ...
                    ret133681 = (vertexes->FMGL(data))[index133680];
                    ret133681;
                }))
                ;
...
class org_scalegraph_graph_VertexTranslator__NoTraslator__closure__11 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long a, x10_long b) {
        ...
        return (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b133464 = b;
            ((a133463) < (b133464)) ? (b133464) : (a133463);
        }))
        ;
...
void org::scalegraph::graph::VertexTranslator__NoTraslator::_constructor(
  x10::util::Team* team__) {
    ...
    org::scalegraph::graph::VertexTranslator<x10_long>* this133677 = this;
    ...
    x10::util::Team* team__133678 = team__;
    ...
    (this133677)->::org::scalegraph::graph::VertexTranslatorBase::_constructor(
      team__133678);
  ...
  org::scalegraph::util::MemoryChunk<x10_long> vertexes, x10_boolean withPut) {
    ...
    if (withPut) {
        ...
        this->FMGL(maxVertexID) = (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long a133465 = x10aux::nullCheck(this->FMGL(team))->reduce(
                                 this->FMGL(teamRank), ((x10_int)0),
                                 localMaxId, ((x10_int)9));
            
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b133466 = this->FMGL(maxVertexID);
            ((a133465) < (b133466)) ? (b133466) : (a133465);
        }))
        ;
    }
