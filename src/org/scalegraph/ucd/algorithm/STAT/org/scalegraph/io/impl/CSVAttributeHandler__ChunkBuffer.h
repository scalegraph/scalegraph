...
template<class TPMGL(T)> class CSVAttributeHandler__ChunkBuffer : public x10::lang::X10Class
  {
    ...
    virtual void __fieldInitializers126303();
...
template<class TPMGL(T)> void org::scalegraph::io::impl::CSVAttributeHandler__ChunkBuffer<TPMGL(T)>::_constructor(
    ...
    org::scalegraph::io::impl::CSVAttributeHandler__ChunkBuffer<TPMGL(T)>* this128516 =
      this;
    ...
    x10aux::nullCheck(this128516)->FMGL(buf) = (x10aux::class_cast_unchecked<org::scalegraph::util::GrowableMemory<TPMGL(T)>*>(X10_NULL));
    
    //#line 69 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/impl/CSVAttributeHandler.x10": Eval of x10.ast.X10FieldAssign_c
    x10aux::nullCheck(this128516)->FMGL(chunkSize) = x10aux::zeroValue<org::scalegraph::util::MemoryChunk<x10_long> >();
    
    //#line 69 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/impl/CSVAttributeHandler.x10": Eval of x10.ast.X10FieldAssign_c
    x10aux::nullCheck(this128516)->FMGL(offset) = ((x10_long)0ll);
}
...
//#line 69 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/impl/CSVAttributeHandler.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(T)> void org::scalegraph::io::impl::CSVAttributeHandler__ChunkBuffer<TPMGL(T)>::__fieldInitializers126303(
  ) {
