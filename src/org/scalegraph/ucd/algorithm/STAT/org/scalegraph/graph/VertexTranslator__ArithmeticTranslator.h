...
template<class TPMGL(T)> class org_scalegraph_graph_VertexTranslator__ArithmeticTranslator__closure__8 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long tid, x10::lang::LongRange r) {
        ...
        x10::lang::LongRange i93422domain133672 = r;
        
        //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i93422min133673 = i93422domain133672->FMGL(min);
        
        //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i93422max133674 = i93422domain133672->FMGL(max);
        ...
        //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": polyglot.ast.For_c
        {
            ...
            for (
                 //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                 i133675 = i93422min133673; ((i133675) <= (i93422max133674));
                 ...
                 i133675 = ((x10_long) ((i133675) + (((x10_long)1ll))))) {
                
                //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                x10_long i133676 = i133675;
                ...
                x10_long v133669 = saved_this->toLong((__extension__ ({
                                                          
                                                          //#line 270 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                                                          x10_long index133670 =
                                                            i133676;
                                                          ...
                                                          TPMGL(T) ret133671;
                                                          {
                                                              ...
                                                              if (((index133670) < (((x10_long) (((x10_int)0))))) ||
                                                                  ((index133670) >= (vertexes->
                                                                                       FMGL(data)->
                                                                                       FMGL(size))))
                                                              {
                                                                  ...
                                                                  if (true)
                                                                  {
                                                                      ...
                                                                      x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index133670), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                                                                  }
                ...
                x10_long index133666 = i133676;
                
                //#line 297 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                x10_long value133667 = v133669;
                ...
                x10_long ret133668;
                {
                    ...
                    if (((index133666) < (((x10_long) (((x10_int)0))))) ||
                        ((index133666) >= (translated->FMGL(data)->
                                             FMGL(size))))
                    {
                        ...
                        if (true) {
                            ...
                            x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index133666), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                        }
                ...
                (translated->FMGL(data)).set(index133666, value133667);
...
template<class TPMGL(T)> class org_scalegraph_graph_VertexTranslator__ArithmeticTranslator__closure__9 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long a, x10_long b) {
        ...
        return (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b133454 = b;
            ((a133453) < (b133454)) ? (b133454) : (a133453);
        }))
        ;
...
template<class TPMGL(T)> void org::scalegraph::graph::VertexTranslator__ArithmeticTranslator<TPMGL(T)>::_constructor(
    ...
    org::scalegraph::graph::VertexTranslator<TPMGL(T)>* this133664 =
      this;
    ...
    x10::util::Team* team__133665 = team__;
    ...
    (this133664)->::org::scalegraph::graph::VertexTranslatorBase::_constructor(
      team__133665);
  ...
  org::scalegraph::util::MemoryChunk<TPMGL(T)> vertexes, x10_boolean withPut) {
    ...
    if (withPut) {
        ...
        this->FMGL(maxVertexID) = (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long a133455 = x10aux::nullCheck(this->FMGL(team))->reduce(
                                 this->FMGL(teamRank), ((x10_int)0),
                                 localMaxId, ((x10_int)9));
            
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b133456 = this->FMGL(maxVertexID);
            ((a133455) < (b133456)) ? (b133456) : (a133455);
        }))
        ;
    }
