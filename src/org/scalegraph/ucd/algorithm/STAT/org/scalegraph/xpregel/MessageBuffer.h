...
template<class TPMGL(M)> class MessageBuffer   {
    ...
    void _constructor() {
        ...
        (*this)->org::scalegraph::xpregel::MessageBuffer<TPMGL(M)>::__fieldInitializers78014();
    }
...
//#line 28 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/xpregel/MessageCommunicator.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(M)> void org::scalegraph::xpregel::MessageBuffer<TPMGL(M)>::__fieldInitializers78014(
  ) {
    ...
    (*this)->FMGL(messages) = (__extension__ ({
        ...
        org::scalegraph::util::GrowableMemory<TPMGL(M)>* alloc78890 =
        ...
        (alloc78890)->::org::scalegraph::util::GrowableMemory<TPMGL(M)>::_constructor(
    ...
    (*this)->FMGL(dstIds) = (__extension__ ({
        ...
        org::scalegraph::util::GrowableMemory<x10_long>* alloc78891 =
        ...
        (alloc78891)->::org::scalegraph::util::GrowableMemory<x10_long>::_constructor(
          ((x10_long) (((x10_int)128))));
        alloc78891;
    }))
    ;
