...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(MAX_OUTPUT_NUMBER__do_init)() {
    ...
    x10_int __var590__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)8));
    FMGL(MAX_OUTPUT_NUMBER) = __var590__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_END_COUNT__do_init)() {
    ...
    x10_int __var591__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)0));
    FMGL(STT_END_COUNT) = __var591__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_ACTIVE_VERTEX__do_init)() {
    ...
    x10_int __var592__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)1));
    FMGL(STT_ACTIVE_VERTEX) = __var592__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_RAW_MESSAGE__do_init)() {
    ...
    x10_int __var593__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)2));
    FMGL(STT_RAW_MESSAGE) = __var593__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_VERTEX_MESSAGE__do_init)() {
    ...
    x10_int __var594__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)3));
    FMGL(STT_VERTEX_MESSAGE) = __var594__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_PRE__do_init)() {
    ...
    x10_int __var595__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)4));
    FMGL(STT_PRE) = __var595__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_COMBINED_MESSAGE__do_init)() {
    ...
    FMGL(STT_COMBINED_MESSAGE) = __var596__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_VERTEX_TRANSFERED_MESSAGE__do_init)() {
    ...
    x10_int __var597__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)5));
    FMGL(STT_VERTEX_TRANSFERED_MESSAGE) = __var597__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_POST__do_init)() {
    ...
    x10_int __var598__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)2));
    FMGL(STT_POST) = __var598__;
...
void org::scalegraph::xpregel::WorkerPlaceGraph<void, void>::FMGL(STT_MAX__do_init)() {
    ...
    x10_int __var599__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)6));
    FMGL(STT_MAX) = __var599__;
                                                                             ...
                                                                             x10::lang::VoidFun_0_2<x10_long, x10::lang::LongRange>* task)
{
    ...
    x10::lang::LongRange range105355 = x10::lang::LongRange::_make(((x10_long) (((x10_int)0))), ((x10_long) ((org::scalegraph::util::Bitmap::numWords(
    ...
    x10_long size105351 = ((x10_long) ((((x10_long) ((range105355->
                                                        FMGL(max)) - (range105355->
    ...
    x10_int nthreads105352 = x10::lang::Runtime::FMGL(NTHREADS__get)();
    ...
    x10_long chunk_size105353 = (__extension__ ({
        
        //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
        x10_long a105354 = ((x10_long) ((((x10_long) ((((x10_long) ((size105351) + (((x10_long) (nthreads105352)))))) - (((x10_long) (((x10_int)1))))))) / x10aux::zeroCheck(((x10_long) (nthreads105352)))));
        
        //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": polyglot.ast.Empty_c
        ;
        ((a105354) < (((x10_long)1ll))) ? (((x10_long)1ll))
          : (a105354);
    }))
    ;
    {
        ...
        x10::lang::FinishState* x10____var76 = x10::lang::Runtime::startFinish();
        {
            ...
            //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": x10.ast.X10LocalDecl_c
            x10::lang::CheckedThrowable* throwable105538 =
                ...
                try {
                    {
                        ...
                        //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": x10.ast.X10LocalDecl_c
                        x10_int i74249max105348 = ((x10_int) ((nthreads105352) - (((x10_int)1))));
                        ...
                        //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": polyglot.ast.For_c
                        {
                            ...
                            for (
                                 //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": x10.ast.X10LocalDecl_c
                                 i105349 = ((x10_int)0); ((i105349) <= (i74249max105348));
                                 ...
                                 i105349 = ((x10_int) ((i105349) + (((x10_int)1)))))
                            {
                                
                                //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": x10.ast.X10LocalDecl_c
                                x10_int i105350 = i105349;
                                ...
                                x10_long i_start105342 = (__extension__ ({
                                    
                                    //#line 352 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
                                    x10_long a105343 = ((x10_long) ((range105355->
                                                                       FMGL(max)) + (((x10_long) (((x10_int)1))))));
                                    
                                    //#line 352 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
                                    x10_long b105344 = ((x10_long) ((range105355->
                                                                       FMGL(min)) + (((x10_long) ((((x10_long) (i105350))) * (chunk_size105353))))));
                                    ((a105343) < (b105344))
                                      ? (a105343) : (b105344);
                                }))
                                ;
                                ...
                                x10::lang::LongRange i_range105345 =
                                  x10::lang::LongRange::_make(i_start105342, (__extension__ ({
                                    
                                    //#line 352 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
                                    x10_long a105346 = range105355->
                                                         FMGL(max);
                                    
                                    //#line 352 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
                                    x10_long b105347 = ((x10_long) ((((x10_long) ((i_start105342) + (chunk_size105353)))) - (((x10_long) (((x10_int)1))))));
                                    ((a105346) < (b105347))
                                      ? (a105346) : (b105347);
                                }))
                                );
                                ...
                                x10::lang::Runtime::runAsync(
                                  reinterpret_cast<x10::lang::VoidFun_0_0*>((new (x10aux::alloc<x10::lang::VoidFun_0_0>(sizeof(org_scalegraph_xpregel_WorkerPlaceGraph__closure__20)))org_scalegraph_xpregel_WorkerPlaceGraph__closure__20(idx105341, i_range105345, numLocalVertexes, task))));
                            }
                        }
                        
                    }
                }
                catch (x10::lang::CheckedThrowable* __exc601) {
                    if (true) {
                        x10::lang::CheckedThrowable* __lowerer__var__0__ =
                          static_cast<x10::lang::CheckedThrowable*>(__exc601);
                        {
            ...
            catch (x10::lang::CheckedThrowable* __exc602) {
                if (true) {
                    x10::lang::CheckedThrowable* formal105539 =
                      static_cast<x10::lang::CheckedThrowable*>(__exc602);
                    {
                        
                        //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": Eval of x10.ast.X10LocalAssign_c
                        throwable105538 = formal105539;
                    }
                } else
                throw;
            }
            ...
            if ((!x10aux::struct_equals(X10_NULL, throwable105538)))
            {
                
                //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": x10.ast.X10If_c
                if (x10aux::instanceof<x10::compiler::Abort*>(throwable105538))
                {
                    
                    //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": polyglot.ast.Throw_c
                    x10aux::throwException(x10aux::nullCheck(throwable105538));
                }
            ...
            if ((!x10aux::struct_equals(X10_NULL, throwable105538)))
            {
                ...
                //#line 874 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/Parallel.x10": x10.ast.X10If_c
                if (!(x10aux::instanceof<x10::compiler::Finalization*>(throwable105538)))
                {
