...
template<class TPMGL(T)> class org_scalegraph_util_DistGrowableMemory__closure__1 : public x10::lang::Closure {
    ...
    org::scalegraph::util::GrowableMemory<TPMGL(T)>* __apply() {
        ...
        return (__extension__ ({
            ...
            org::scalegraph::util::GrowableMemory<TPMGL(T)>* alloc125188 =
            ...
            (alloc125188)->::org::scalegraph::util::GrowableMemory<TPMGL(T)>::_constructor(
              ((x10_long)0ll));
            alloc125188;
        }))
        ;
...
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
  ...
  x10::array::PlaceGroup* placeGroup) {
    ...
    return (__extension__ ({
        ...
        org::scalegraph::util::DistMemoryChunk<TPMGL(T)> alloc125189 =
        ...
        (alloc125189)->::org::scalegraph::util::DistMemoryChunk<TPMGL(T)>::_constructor(
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::DistGrowableMemory<TPMGL(T)>::equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> this125192 =
          (*this);
        
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> other125191 =
          x10aux::class_cast<org::scalegraph::util::DistGrowableMemory<TPMGL(T)> >(other);
        (x10aux::struct_equals(this125192->FMGL(plh), other125191->
                                                        FMGL(plh)));
    }))
    ;
...
template<class TPMGL(T)> x10_boolean org::scalegraph::util::DistGrowableMemory<TPMGL(T)>::_struct_equals(
  x10::lang::Any* other) {
    ...
    return (__extension__ ({
        ...
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> this125194 =
          (*this);
        
        //#line 16 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/DistGrowableMemory.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::DistGrowableMemory<TPMGL(T)> other125193 =
          x10aux::class_cast<org::scalegraph::util::DistGrowableMemory<TPMGL(T)> >(other);
        (x10aux::struct_equals(this125194->FMGL(plh), other125193->
                                                        FMGL(plh)));
    }))
    ;
