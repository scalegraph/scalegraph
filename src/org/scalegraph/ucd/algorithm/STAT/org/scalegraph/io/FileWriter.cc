...
void org::scalegraph::io::FileWriter::_constructor(org::scalegraph::util::SString path,
    ...
    org::scalegraph::io::FileWriter* this129070 = this;
    ...
    x10aux::nullCheck(this129070)->FMGL(fileOffset) = ((x10_long)0ll);
...
void org::scalegraph::io::FileWriter::skip(x10_long n) {
    ...
    org::scalegraph::io::FileWriter* x129071 = this;
    ...
    x10aux::nullCheck(x129071)->FMGL(fileOffset) = ((x10_long) ((x10aux::nullCheck(x129071)->
                                                                   FMGL(fileOffset)) + (y129072)));
...
//#line 21 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/FileWriter.x10": x10.ast.X10MethodDecl_c
void org::scalegraph::io::FileWriter::__fieldInitializers128148(
  ) {
