...
class NamedDistData : public x10::lang::X10Class   {
    ...
    virtual void __fieldInitializers82531();
...
#ifndef ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_157
#define ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_157
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
...
#endif // ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_157
#ifndef ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_158
#define ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_158
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
  org::scalegraph::io::NamedDistData::get(x10_int index) {
    ...
    x10::lang::Any* data_ = (__extension__ ({
        ...
        }goto __ret84744_end_; __ret84744_end_: ;
        }
        ret84743;
        }))
        ;
    ...
    #endif // ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_158
