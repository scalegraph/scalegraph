...
class IdStruct   {
    ...
    x10_long localIDMask() {
        ...
        return ((x10_long) (((__extension__ ({
            ...
            org::scalegraph::graph::id::IdStruct this108388 =
              (*this);
            ((x10_long) ((((x10_long)1ll)) << (0x3f & (this108388->
                                                         FMGL(lgl)))));
        }))
        ) - (((x10_long) (((x10_int)1))))));
    ...
    x10_long localRIDMask() {
        ...
        return ((x10_long) (((__extension__ ({
            ...
            org::scalegraph::graph::id::IdStruct this108389 =
              (*this);
            ((x10_long) ((((x10_long)1ll)) << (0x3f & (((x10_int) ((this108389->
                                                                      FMGL(lgr)) + (this108389->
                                                                                      FMGL(lgl))))))));
        }))
        ) - (((x10_long) (((x10_int)1))))));
    ...
    x10_long localCIDMask() {
        ...
        return ((x10_long) (((__extension__ ({
            ...
            org::scalegraph::graph::id::IdStruct this108390 =
              (*this);
            ((x10_long) ((((x10_long)1ll)) << (0x3f & (((x10_int) ((this108390->
                                                                      FMGL(lgc)) + (this108390->
                                                                                      FMGL(lgl))))))));
        }))
        ) - (((x10_long) (((x10_int)1))))));
