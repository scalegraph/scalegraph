...
template<class TPMGL(T)> class MemoryChunk__Distributor : public x10::lang::X10Class
  {
    ...
    virtual void __fieldInitializers54550();
...
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::_constructor(
    ...
    org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* this83859 =
      this;
    ...
    x10aux::nullCheck(this83859)->FMGL(offset) = ((x10_long) (((x10_int)0)));
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  ...
  x10_long size) {
    ...
    org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* x83860 =
      this;
    
    //#line 56 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
    x10_long y83861 = size;
    ...
    x10aux::nullCheck(x83860)->FMGL(offset) = ((x10_long) ((x10aux::nullCheck(x83860)->
                                                              FMGL(offset)) + (y83861)));
...
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk<TPMGL(T)>
  ...
  x10_int size) {
    ...
    org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>* x83862 =
      this;
    ...
    x10aux::nullCheck(x83862)->FMGL(offset) = ((x10_long) ((x10aux::nullCheck(x83862)->
                                                              FMGL(offset)) + (((x10_long) (y83863)))));
...
template<class TPMGL(T)> x10_long org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::remain(
    ...
    return ((x10_long) (((__extension__ ({
        ...
        org::scalegraph::util::MemoryChunk<TPMGL(T)> this82749 =
          this->FMGL(outer);
        this82749->FMGL(data)->FMGL(size);
    }))
    ) - (this->FMGL(offset))));
...
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::checkFinish(
    ...
    if ((!x10aux::struct_equals(this->FMGL(offset), (__extension__ ({
                                    ...
                                    org::scalegraph::util::MemoryChunk<TPMGL(T)> this82750 =
                                      this->FMGL(outer);
                                    this82750->FMGL(data)->
                                      FMGL(size);
                                }))
...
//#line 41 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__Distributor<TPMGL(T)>::__fieldInitializers54550(
  ) {
