...
void org::scalegraph::io::FileWriter::_constructor(org::scalegraph::util::SString path,
    ...
    org::scalegraph::io::FileWriter* this137881 = this;
    ...
    x10aux::nullCheck(this137881)->FMGL(fileOffset) = ((x10_long)0ll);
...
void org::scalegraph::io::FileWriter::skip(x10_long n) {
    ...
    org::scalegraph::io::FileWriter* x137882 = this;
    ...
    x10aux::nullCheck(x137882)->FMGL(fileOffset) = ((x10_long) ((x10aux::nullCheck(x137882)->
                                                                   FMGL(fileOffset)) + (y137883)));
...
//#line 21 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/io/FileWriter.x10": x10.ast.X10MethodDecl_c
void org::scalegraph::io::FileWriter::__fieldInitializers133906(
  ) {
