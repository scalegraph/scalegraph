...
class OnedC__VtoD   {
    ...
    x10_long __apply(x10_long id) {
        ...
        //#line 32 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/id/OnedC.x10": x10.ast.X10Return_c
        return ((x10_long) ((id) >> (0x3f & ((*this)->FMGL(lgc)))));
        
    }
    x10_int c(x10_long id) {
        
        //#line 33 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/id/OnedC.x10": x10.ast.X10Return_c
