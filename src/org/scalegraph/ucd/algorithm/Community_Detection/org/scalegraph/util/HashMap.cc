...
void org::scalegraph::util::HashMap<void, void>::FMGL(nChunk__do_init)() {
    ...
    x10_int __var1822__ = x10aux::class_cast_unchecked<x10_int>(org::scalegraph::util::HashMap<void, void>::pow2floor(
                                                                  x10::lang::Runtime::
                                                                    FMGL(NTHREADS__get)()));
    FMGL(nChunk) = __var1822__;
...
void org::scalegraph::util::HashMap<void, void>::FMGL(nMaskBits__do_init)() {
    ...
    x10_int __var1823__ = x10aux::class_cast_unchecked<x10_int>(63 - __builtin_clzl(((((x10_long) (org::scalegraph::util::HashMap<void, void>::
                                                                                                     FMGL(nChunk__get)()))) << 1) - 1));
    FMGL(nMaskBits) = __var1823__;
...
void org::scalegraph::util::HashMap<void, void>::FMGL(MAX_PROBES__do_init)() {
    ...
    x10_int __var1824__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)3));
    FMGL(MAX_PROBES) = __var1824__;
...
void org::scalegraph::util::HashMap<void, void>::FMGL(MIN_SIZE__do_init)() {
    ...
    x10_int __var1825__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)4));
    FMGL(MIN_SIZE) = __var1825__;
...
void org::scalegraph::util::HashMap__HashEntry<void, void>::FMGL(EMPTY__do_init)() {
    ...
    x10_byte __var1836__ = x10aux::class_cast_unchecked<x10_byte>(((x10_byte) (((x10_int)0))));
    FMGL(EMPTY) = __var1836__;
...
void org::scalegraph::util::HashMap__HashEntry<void, void>::FMGL(OCCUPIED__do_init)() {
    ...
    x10_byte __var1837__ = x10aux::class_cast_unchecked<x10_byte>(((x10_byte) (((x10_int)1))));
    FMGL(OCCUPIED) = __var1837__;
...
void org::scalegraph::util::HashMap__HashEntry<void, void>::FMGL(DUMMY__do_init)() {
    ...
    x10_byte __var1838__ = x10aux::class_cast_unchecked<x10_byte>(((x10_byte) (((x10_int)2))));
    FMGL(DUMMY) = __var1838__;
