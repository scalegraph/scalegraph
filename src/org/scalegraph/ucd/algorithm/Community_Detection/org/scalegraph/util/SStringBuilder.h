...
class SStringBuilder   {
    ...
    void __fieldInitializers108120();
...
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1684
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1684
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1684
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1685
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1685
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1685
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1686
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1686
template<class TPMGL(T1), class TPMGL(T2)> org::scalegraph::util::SStringBuilder
  org::scalegraph::util::SStringBuilder::add(org::scalegraph::util::SString fmt,
                                             TPMGL(T1) o1,
                                             TPMGL(T2) o2){
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1686
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1687
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1687
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3)>
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1687
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1688
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1688
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1688
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1689
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1689
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4), class TPMGL(T5)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1689
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1690
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1690
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4), class TPMGL(T5), class TPMGL(T6)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1690
