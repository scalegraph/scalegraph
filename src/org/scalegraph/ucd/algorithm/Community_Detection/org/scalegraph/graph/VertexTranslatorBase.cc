...
void org::scalegraph::graph::VertexTranslatorBase::_constructor(x10::util::Team* team__) {
    ...
    org::scalegraph::graph::VertexTranslatorBase* this122798 = this;
    ...
    x10aux::nullCheck(this122798)->FMGL(maxVertexID) = ((x10_long) (((x10_int)0)));
    ...
    this->FMGL(teamRank) = (__extension__ ({
        ...
        x10::array::Array<x10_int>* this122795 = x10aux::nullCheck(this->
                                                                     FMGL(team))->role();
        ...
        goto __ret122797; __ret122797: {
        {
            ...
            if (x10aux::nullCheck(this122795)->FMGL(rail)) {
                ...
                ret122796 = (x10aux::nullCheck(this122795)->FMGL(raw))->__apply(((x10_int) ((((x10_int)0)) - (x10aux::nullCheck(this122795)->
                                                                                                                FMGL(layout_min0)))));
        ...
        }goto __ret122797_end_; __ret122797_end_: ;
        }
        ret122796;
        }))
        ;
...
//#line 15 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslatorBase.x10": x10.ast.X10MethodDecl_c
void org::scalegraph::graph::VertexTranslatorBase::__fieldInitializers94546(
  ) {
