...
template<class TPMGL(T)> class org_scalegraph_graph_VertexTranslator__ArithmeticTranslator__closure__8 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long tid, x10::lang::LongRange r) {
        ...
        x10::lang::LongRange i94375domain132011 = r;
        
        //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i94375min132012 = i94375domain132011->FMGL(min);
        
        //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i94375max132013 = i94375domain132011->FMGL(max);
        ...
        //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": polyglot.ast.For_c
        {
            ...
            for (
                 //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                 i132014 = i94375min132012; ((i132014) <= (i94375max132013));
                 ...
                 i132014 = ((x10_long) ((i132014) + (((x10_long)1ll))))) {
                
                //#line 286 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                x10_long i132015 = i132014;
                ...
                x10_long v132008 = saved_this->toLong((__extension__ ({
                                                          
                                                          //#line 270 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                                                          x10_long index132009 =
                                                            i132015;
                                                          ...
                                                          TPMGL(T) ret132010;
                                                          {
                                                              ...
                                                              if (((index132009) < (((x10_long) (((x10_int)0))))) ||
                                                                  ((index132009) >= (vertexes->
                                                                                       FMGL(data)->
                                                                                       FMGL(size))))
                                                              {
                                                                  ...
                                                                  if (true)
                                                                  {
                                                                      ...
                                                                      x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index132009), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                                                                  }
                ...
                x10_long index132005 = i132015;
                
                //#line 297 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                x10_long value132006 = v132008;
                ...
                x10_long ret132007;
                {
                    ...
                    if (((index132005) < (((x10_long) (((x10_int)0))))) ||
                        ((index132005) >= (translated->FMGL(data)->
                                             FMGL(size))))
                    {
                        ...
                        if (true) {
                            ...
                            x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index132005), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                        }
                ...
                (translated->FMGL(data)).set(index132005, value132006);
...
template<class TPMGL(T)> class org_scalegraph_graph_VertexTranslator__ArithmeticTranslator__closure__9 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long a, x10_long b) {
        ...
        return (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b131793 = b;
            ((a131792) < (b131793)) ? (b131793) : (a131792);
        }))
        ;
...
template<class TPMGL(T)> void org::scalegraph::graph::VertexTranslator__ArithmeticTranslator<TPMGL(T)>::_constructor(
    ...
    org::scalegraph::graph::VertexTranslator<TPMGL(T)>* this132003 =
      this;
    ...
    x10::util::Team* team__132004 = team__;
    ...
    (this132003)->::org::scalegraph::graph::VertexTranslatorBase::_constructor(
      team__132004);
  ...
  org::scalegraph::util::MemoryChunk<TPMGL(T)> vertexes, x10_boolean withPut) {
    ...
    if (withPut) {
        ...
        this->FMGL(maxVertexID) = (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long a131794 = x10aux::nullCheck(this->FMGL(team))->reduce(
                                 this->FMGL(teamRank), ((x10_int)0),
                                 localMaxId, ((x10_int)9));
            
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b131795 = this->FMGL(maxVertexID);
            ((a131794) < (b131795)) ? (b131795) : (a131794);
        }))
        ;
    }
