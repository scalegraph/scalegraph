...
class NamedDistData : public x10::lang::X10Class   {
    ...
    virtual void __fieldInitializers87647();
...
#ifndef ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_1491
#define ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_1491
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
...
#endif // ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_1491
#ifndef ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_1492
#define ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_1492
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
  org::scalegraph::io::NamedDistData::get(x10_int index) {
    ...
    x10::lang::Any* data_ = (__extension__ ({
        ...
        }goto __ret129564_end_; __ret129564_end_: ;
        }
        ret129563;
        }))
        ;
    ...
    #endif // ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_1492
