...
void org::scalegraph::graph::VertexTranslator<void>::FMGL(debug__do_init)() {
    ...
    x10_boolean __var1503__ = x10aux::class_cast_unchecked<x10_boolean>(true);
    FMGL(debug) = __var1503__;
...
class org_scalegraph_graph_VertexTranslator__NoTraslator__closure__10 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long tid, x10::lang::LongRange r) {
        ...
        x10::lang::LongRange i94394domain132021 = r;
        
        //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i94394min132022 = i94394domain132021->FMGL(min);
        
        //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
        x10_long i94394max132023 = i94394domain132021->FMGL(max);
        ...
        //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": polyglot.ast.For_c
        {
            ...
            for (
                 //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                 i132024 = i94394min132022; ((i132024) <= (i94394max132023));
                 ...
                 i132024 = ((x10_long) ((i132024) + (((x10_long)1ll))))) {
                
                //#line 311 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/graph/VertexTranslator.x10": x10.ast.X10LocalDecl_c
                x10_long i132025 = i132024;
                ...
                x10_long v132018 = (__extension__ ({
                    
                    //#line 270 "/nfs/home/vinodmadaan/ScaleGraph_Stable_Version/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
                    x10_long index132019 = i132025;
                    ...
                    x10_long ret132020;
                    {
                        ...
                        if (((index132019) < (((x10_long) (((x10_int)0))))) ||
                            ((index132019) >= (vertexes->FMGL(data)->FMGL(size))))
                        {
                            ...
                            if (true) {
                                ...
                                x10aux::throwException(x10aux::nullCheck(x10::lang::ArrayIndexOutOfBoundsException::_make(x10::lang::String::__plus(x10::lang::String::__plus(x10aux::makeStringLit("index ("), index132019), x10aux::makeStringLit(") not contained in MemoryChunk")))));
                            }
                    ...
                    ret132020 = (vertexes->FMGL(data))[index132019];
                    ret132020;
                }))
                ;
...
class org_scalegraph_graph_VertexTranslator__NoTraslator__closure__11 : public x10::lang::Closure {
    ...
    x10_long __apply(x10_long a, x10_long b) {
        ...
        return (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b131803 = b;
            ((a131802) < (b131803)) ? (b131803) : (a131802);
        }))
        ;
...
void org::scalegraph::graph::VertexTranslator__NoTraslator::_constructor(
  x10::util::Team* team__) {
    ...
    org::scalegraph::graph::VertexTranslator<x10_long>* this132016 = this;
    ...
    x10::util::Team* team__132017 = team__;
    ...
    (this132016)->::org::scalegraph::graph::VertexTranslatorBase::_constructor(
      team__132017);
  ...
  org::scalegraph::util::MemoryChunk<x10_long> vertexes, x10_boolean withPut) {
    ...
    if (withPut) {
        ...
        this->FMGL(maxVertexID) = (__extension__ ({
            ...
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long a131804 = x10aux::nullCheck(this->FMGL(team))->reduce(
                                 this->FMGL(teamRank), ((x10_int)0),
                                 localMaxId, ((x10_int)9));
            
            //#line 351 "/usr/global/x10/x10-trunk-custom/x10.dist/stdlib/x10.jar:x10/lang/Math.x10": x10.ast.X10LocalDecl_c
            x10_long b131805 = this->FMGL(maxVertexID);
            ((a131804) < (b131805)) ? (b131805) : (a131804);
        }))
        ;
    }
