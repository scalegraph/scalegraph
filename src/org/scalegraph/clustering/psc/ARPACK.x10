...
public class ARPACK {
	...
	@Native("c++", "pdseupd_wrap(#comm, #rvec, #howmny, (#select)->raw()->raw(), (#d)->raw()->raw(), (#z)->raw()->raw(), #ldz, #sigma, #bmat, #n, #which, #nev, #tol, (#resid)->raw()->raw(), #ncv, (#v)->raw()->raw(), #ldv, (#iparam)->raw()->raw(), (#ipntr)->raw()->raw(), (#workd)->raw()->raw(), (#workl)->raw()->raw(), #lworkl, &#info)")
