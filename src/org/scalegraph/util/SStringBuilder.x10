...
public class SStringBuilder {
	...
	@Native("c++", "org::scalegraph::util::StringBuilderAdd_((#this)->FMGL(buffer),#x)")
	public native def add[T](x :T) :SStringBuilder;

	@Native("c++", "org::scalegraph::util::StringBuilderFmtAdd_((#this)->FMGL(buffer),#fmt,#o1)")
	public native def add[T1](fmt :SString, o1 :T1) :SStringBuilder;
	
	@Native("c++", "org::scalegraph::util::StringBuilderFmtAdd_((#this)->FMGL(buffer),#fmt,#o1,#o2)")
	public native def add[T1,T2](fmt :SString, o1 :T1, o2 :T2) :SStringBuilder;
	
	@Native("c++", "org::scalegraph::util::StringBuilderFmtAdd_((#this)->FMGL(buffer),#fmt,#o1,#o2,#o3)")
	public native def add[T1,T2,T3](fmt :SString, o1 :T1, o2 :T2, o3 :T3) :SStringBuilder;
	
	@Native("c++", "org::scalegraph::util::StringBuilderFmtAdd_((#this)->FMGL(buffer),#fmt,#o1,#o2,#o3,#o4)")
	public native def add[T1,T2,T3,T4](fmt :SString, o1 :T1, o2 :T2, o3 :T3, o4 :T4) :SStringBuilder;
	
	@Native("c++", "org::scalegraph::util::StringBuilderFmtAdd_((#this)->FMGL(buffer),#fmt,#o1,#o2,#o3,#o4,#o5)")
	public native def add[T1,T2,T3,T4,T5](fmt :SString, o1 :T1, o2 :T2, o3 :T3, o4 :T4, o5 :T5) :SStringBuilder;
	
	@Native("c++", "org::scalegraph::util::StringBuilderFmtAdd_((#this)->FMGL(buffer),#fmt,#o1,#o2,#o3,#o4,#o5,#o6)")
