...
#ifdef __MTA__
#include "org/scalegraph/util/random/mod_arith_xmt.h"
#else
#ifdef FAST_64BIT_ARITHMETIC
#include "org/scalegraph/util/random/mod_arith_64bit.h"
#else
#include "org/scalegraph/util/random/mod_arith_32bit.h"
#endif
#endif
