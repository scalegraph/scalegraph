...
/**
 * This class represents Byte attribute
 */
public class ByteAttribute extends Attribute {
	
	protected var name: String;
	protected var value: Byte;
	...
	public def this(name: String, value: Byte) {
		this.name = name;
		this.value = value;
	}
	...
	public def getValue(): Byte {
		return this.value;
	}
	
	public def setValue(v: Any) {
		this.value = v as Byte;
	}
	...
	public def clone(): Attribute {
		return new ByteAttribute(this.name, this.value);
	}
