...
/**
 * This class represents Long attribute
 */
public class LongAttribute extends Attribute {
	...
	public def this(name: String, value: Long) {
		this.name = name;
		this.value = value;
	}
	...
	public def getValue(): Long {
		return this.value;
	}
	
	public def setValue(v: Any): void {
		this.value = v as Long;
	}
	...
	public def clone(): Attribute {
		return new LongAttribute(this.name, this.value);
	}
