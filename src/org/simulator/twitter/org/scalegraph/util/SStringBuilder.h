...
class SStringBuilder   {
    ...
    void _constructor() {
        ...
        //#line 25 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/SStringBuilder.x10": polyglot.ast.Empty_c
        ;
        
        //#line 25 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/SStringBuilder.x10": x10.ast.AssignPropertyCall_c
    ...
    org::scalegraph::util::SStringBuilder org__scalegraph__util__SStringBuilder____this__org__scalegraph__util__SStringBuilder(
        ...
        //#line 18 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/SStringBuilder.x10": x10.ast.X10Return_c
        return (*this);
        
    }
    void __fieldInitializers67609();
...
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1317
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1317
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1317
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1318
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1318
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1318
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1319
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1319
template<class TPMGL(T1), class TPMGL(T2)> org::scalegraph::util::SStringBuilder
  org::scalegraph::util::SStringBuilder::add(org::scalegraph::util::SString fmt,
                                             TPMGL(T1) o1,
                                             TPMGL(T2) o2){
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1319
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1320
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1320
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3)>
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1320
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1321
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1321
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1321
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1322
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1322
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4), class TPMGL(T5)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1322
#ifndef ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1323
#define ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1323
template<class TPMGL(T1), class TPMGL(T2), class TPMGL(T3), class TPMGL(T4), class TPMGL(T5), class TPMGL(T6)>
org::scalegraph::util::SStringBuilder org::scalegraph::util::SStringBuilder::add(
  org::scalegraph::util::SString fmt, TPMGL(T1) o1, TPMGL(T2) o2,
...
#endif // ORG_SCALEGRAPH_UTIL_SSTRINGBUILDER_H_add_1323
