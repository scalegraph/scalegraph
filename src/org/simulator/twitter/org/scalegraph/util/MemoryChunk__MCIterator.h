...
template<class TPMGL(T)> class MemoryChunk__MCIterator : public x10::lang::X10Class
  {
    ...
    virtual void __fieldInitializers40984();
...
//#line 212 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10FieldDecl_c

//#line 213 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10FieldDecl_c

//#line 215 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10ConstructorDecl_c
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>::_constructor(
                           org::scalegraph::util::MCData_Impl<TPMGL(T) > data) {
    
    //#line 215 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": polyglot.ast.Empty_c
    ;
    
    //#line 215 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.AssignPropertyCall_c
    
    //#line 211 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": Eval of x10.ast.X10Call_c
    this->org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>::__fieldInitializers40984();
    
    //#line 216 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": Eval of x10.ast.X10FieldAssign_c
    this->FMGL(data) = data;
}
...
//#line 220 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(T)> x10_boolean org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>::hasNext(
  ) {
    
    //#line 220 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10Return_c
    return ((this->FMGL(cur)) < (this->FMGL(data)->FMGL(size)));
    
}

//#line 221 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(T)> TPMGL(T) org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>::next(
  ) {
    
    //#line 221 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10Return_c
    return (this->FMGL(data))[((x10_long) (((__extension__ ({
        
        //#line 221 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10LocalDecl_c
        org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>* x41785 =
          this;
        
        //#line 221 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": polyglot.ast.Empty_c
        ;
        x10aux::nullCheck(x41785)->FMGL(cur) = ((x10_long) ((x10aux::nullCheck(x41785)->
...
//#line 211 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(T)> org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>*
  org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>::org__scalegraph__util__MemoryChunk__MCIterator____this__org__scalegraph__util__MemoryChunk__MCIterator(
    ...
    //#line 211 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10Return_c
    return this;
    
}

//#line 211 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": x10.ast.X10MethodDecl_c
template<class TPMGL(T)> void org::scalegraph::util::MemoryChunk__MCIterator<TPMGL(T)>::__fieldInitializers40984(
  ) {
    
    //#line 211 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/MemoryChunk.x10": Eval of x10.ast.X10FieldAssign_c
