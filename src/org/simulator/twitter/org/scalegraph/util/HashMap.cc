...
x10_int org::scalegraph::util::HashMap<void, void>::pow2floor(x10_int x) {
                                                                             ...
                                                                             //#line 76 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/HashMap.x10": x10.ast.X10LocalDecl_c
                                                                             x10_int pow2 =
                                                                               ((x10_int)1);
                                                                             
                                                                             //#line 77 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/HashMap.x10": x10.ast.X10While_c
                                                                             while (((pow2) < (x)))
                                                                             {
                                                                                 
                                                                                 //#line 78 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/HashMap.x10": Eval of x10.ast.X10LocalAssign_c
                                                                                 pow2 =
                                                                                   ((x10_int) ((pow2) << (0x1f & (((x10_int)1)))));
                                                                             }
                                                                             
                                                                             //#line 80 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/HashMap.x10": x10.ast.X10Return_c
                                                                             return pow2;
...
void org::scalegraph::util::HashMap<void, void>::FMGL(nChunk__do_init)() {
    ...
    x10_int __var1285__ = x10aux::class_cast_unchecked<x10_int>(org::scalegraph::util::HashMap<void, void>::pow2floor(
                                                                  x10::lang::Runtime::
                                                                    FMGL(NTHREADS__get)()));
    FMGL(nChunk) = __var1285__;
...
void org::scalegraph::util::HashMap<void, void>::FMGL(nMaskBits__do_init)() {
    ...
    x10_int __var1286__ = x10aux::class_cast_unchecked<x10_int>(63 - __builtin_clzl(((((x10_long) (org::scalegraph::util::HashMap<void, void>::
                                                                                                     FMGL(nChunk__get)()))) << 1) - 1));
    FMGL(nMaskBits) = __var1286__;
...
void org::scalegraph::util::HashMap<void, void>::FMGL(MAX_PROBES__do_init)() {
    ...
    x10_int __var1287__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)3));
    FMGL(MAX_PROBES) = __var1287__;
...
void org::scalegraph::util::HashMap<void, void>::FMGL(MIN_SIZE__do_init)() {
    ...
    x10_int __var1288__ = x10aux::class_cast_unchecked<x10_int>(((x10_int)4));
    FMGL(MIN_SIZE) = __var1288__;
                                                                ...
                                                                x10_int n)
{
    ...
    //#line 141 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/util/HashMap.x10": x10.ast.X10Return_c
...
void org::scalegraph::util::HashMap__HashEntry<void, void>::FMGL(EMPTY__do_init)() {
    ...
    x10_byte __var1299__ = x10aux::class_cast_unchecked<x10_byte>(((x10_byte) (((x10_int)0))));
    FMGL(EMPTY) = __var1299__;
...
void org::scalegraph::util::HashMap__HashEntry<void, void>::FMGL(OCCUPIED__do_init)() {
    ...
    x10_byte __var1300__ = x10aux::class_cast_unchecked<x10_byte>(((x10_byte) (((x10_int)1))));
    FMGL(OCCUPIED) = __var1300__;
...
void org::scalegraph::util::HashMap__HashEntry<void, void>::FMGL(DUMMY__do_init)() {
    ...
    x10_byte __var1301__ = x10aux::class_cast_unchecked<x10_byte>(((x10_byte) (((x10_int)2))));
    FMGL(DUMMY) = __var1301__;
