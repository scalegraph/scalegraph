...
class OnedC__DtoS   {
    ...
    x10_long __apply(x10_long id) {
        ...
        //#line 77 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/graph/id/OnedC.x10": x10.ast.X10Return_c
        return ((x10_long) ((id) | ((*this)->FMGL(cshifted))));
        
    }
    x10_int c(x10_long id) {
        
        //#line 78 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/graph/id/OnedC.x10": x10.ast.X10Return_c
        return (*this)->FMGL(c);
