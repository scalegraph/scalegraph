...
class NamedDistData : public x10::lang::X10Class   {
    ...
    virtual void __fieldInitializers48685();
...
#ifndef ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_441
#define ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_441
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
  org::scalegraph::io::NamedDistData::get(org::scalegraph::util::SString name_) {
    
    //#line 97 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/io/NamedDistData.x10": x10.ast.X10Return_c
    return this->template get<TPMGL(T) >(this->nameToIndex(name_));
    
}
#endif // ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_441
#ifndef ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_442
#define ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_442
template<class TPMGL(T)> org::scalegraph::util::DistMemoryChunk<TPMGL(T)>
  org::scalegraph::io::NamedDistData::get(x10_int index) {
    
    //#line 100 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/io/NamedDistData.x10": x10.ast.X10LocalDecl_c
    x10::lang::Any* data_ = x10aux::nullCheck(this->FMGL(data))->x10::array::Array<x10::lang::Any*>::__apply(
                              index);
    
    //#line 101 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/io/NamedDistData.x10": x10.ast.X10If_c
    if (x10aux::instanceof<org::scalegraph::util::DistMemoryChunk<TPMGL(T)> >(data_))
    {
        
        //#line 102 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/io/NamedDistData.x10": x10.ast.X10Return_c
        return x10aux::class_cast<org::scalegraph::util::DistMemoryChunk<TPMGL(T)> >(data_);
        
    }
    
    //#line 104 "/home/mukul/ScaleGraph/scalegraph/src/org/scalegraph/io/NamedDistData.x10": polyglot.ast.Throw_c
...
#endif // ORG_SCALEGRAPH_IO_NAMEDDISTDATA_H_get_442
